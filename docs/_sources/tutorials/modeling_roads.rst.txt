...
4. Call the :meth:`render` method to display the road network model on the map canvas::
...
5. To save the model for future reference, call the :meth:`to_gpkg` method::
